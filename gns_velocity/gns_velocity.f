...
c
	...
	do i=1,ny
		...
		write(3,32)iout(i),ylat(i),xlong(i),vely(1,i),vely(2,i),
	1		se1,se2,cor12
	end do

	stop
32	format(1x,i4,2x,f10.5,2x,f10.5,2x,e15.8,2x,e15.8,2x,e15.8,
	1	2x,e15.8,2x,f11.8)
31	format(1x,' no.',2x,'   LAT.   ',2x,'   LONG.  ',2x,
	1	'     Vlong     ',2x,'     Vlat      ',2x,
	2	'     SElong    ',2x,'     SElat     ',2x,
	3	'Correlation')
	end
c
c
...
20		print *,'Do you want the variance-covariance matrices (Y/N)?'
	...
	print *,'Enter the latitude and longitude (in degrees) of the Euler'
...
c
	open(unit=1,file='solution.gns',form='formatted',status='old')
...
c	read(*,*) name
	open(unit=2,file='lat_long.dat',form='formatted',status='old')
	read(2,*) nin
	...
	do i=1,nin
		...
		if (ia.ne.i) stop 'A POINT HAS THE WRONG INDEX'
